    ...
    logger::severity severity) const
{
    for (auto & logger_stream : _logger_streams)
    {
        ...
        {
            std::cout << get_severity(logger_stream.second.second) << "[" << get_time() << "] " << to_log << std::endl;
        }
        else
        {
            (*logger_stream.second.first) << get_severity(logger_stream.second.second) << "[" << get_time() << "] " << to_log << std::endl;
        }
    }
