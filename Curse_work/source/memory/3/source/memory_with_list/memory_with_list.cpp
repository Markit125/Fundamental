...
void *allocating::memory_with_list::find_first_fit(size_t size) const {
    ...
    safe_log("prt_next: " + cast_to_str(*ptr_next), logging::logger::severity::trace);
...
size_t allocating::memory_with_list::get_space_beetween(void *ptr_current, void *ptr_next) {
