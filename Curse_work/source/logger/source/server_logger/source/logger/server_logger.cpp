...
std::map<std::string, std::pair<std::ofstream *, size_t>> logging::logger_server::_streams =
    std::map<std::string, std::pair<std::ofstream *, size_t>>();

logging::logger_server::logger_server(
...
logging::logger const *logging::logger_server::log(
